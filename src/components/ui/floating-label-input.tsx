  ...
  return (
    ...
    >
      <Input
        ...
        {...props}
      />
      <label className="pointer-events-none absolute left-2.5 top-1/2 -translate-y-1/2 bg-card px-1 text-sm text-muted-foreground transition-all duration-150 ease-out peer-focus:top-0 peer-focus:text-xs peer-focus:text-primary peer-[:not(:placeholder-shown)]:top-0 peer-[:not(:placeholder-shown)]:text-xs">
        {label}
      </label>
    </div>
  );
